...
<div>
<center><img src="images/Logo.png" align="center"  width="150" height="150"></center>
</div class='img'>
...
<body>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>20UCS501D</td>
        <td colspan="2">Computer Architecture and Peripheral</td>
        <td>Theory</td>
        <td>60</td>
        <td> 30 </td>
...
else
{
	...
	response.sendRedirect("errorDigiOneView.html");
	}
}
catch(Exception e)
{}%>
